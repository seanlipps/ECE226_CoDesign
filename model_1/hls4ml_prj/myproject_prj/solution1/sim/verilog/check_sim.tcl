...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject.autotvout_layer7_out_0.dat"
         "rtl.myproject.autotvout_layer7_out_1.dat"
         "rtl.myproject.autotvout_layer7_out_2.dat"
         "rtl.myproject.autotvout_layer7_out_3.dat"
         "rtl.myproject.autotvout_layer7_out_4.dat"
         "rtl.myproject.autotvout_layer7_out_5.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
