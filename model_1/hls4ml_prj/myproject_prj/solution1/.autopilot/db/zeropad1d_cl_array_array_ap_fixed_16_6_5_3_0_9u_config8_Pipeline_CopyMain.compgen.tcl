...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_5_TVALID { I 1 bit } input_5_TDATA { I 144 vector } input_5_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer8_out_din { O 144 vector } layer8_out_num_data_valid { I 9 vector } layer8_out_fifo_cap { I 9 vector } layer8_out_full_n { I 1 bit } layer8_out_write { O 1 bit } } \
} "
}
