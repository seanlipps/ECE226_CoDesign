set moduleName relu_array_ap_fixed_16u_array_ap_fixed_16_6_5_3_0_16u_relu_config4_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,16u>,array<ap_fixed<16,6,5,3,0>,16u>,relu_config4>}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer2_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer2_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer4_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data_in 0 256 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer2_out_fifo_cap fifo_update 0 8 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_port_we 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_data_in 1 256 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer4_out_fifo_cap fifo_update 0 8 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_port_we 1 1 } } }
}
